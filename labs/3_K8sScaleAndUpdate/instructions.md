...
```
{: codeblock}
<img src="images/step_3.2"><br/>

3. List Pods until the status is "Running".
```
kubectl get pods
```
<img src="images/step_3.3"><br/>
